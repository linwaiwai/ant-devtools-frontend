...
ServicePort.prototype={setHandlers:function(messageHandler,closeHandler){},send:function(message){},close:function(){}};var runtime;self['Platform']=self['Platform']||{};console=console;console.__originalAssert=console.assert;console.assert=function(value,message){if(value)
...
return(node.host);return null;};Node.prototype.parentNodeOrShadowHost=function(){return this.parentNode||this.host||null;};Node.prototype.getComponentSelection=function(){var parent=this.parentNode;while(parent&&parent.nodeType!==Node.DOCUMENT_FRAGMENT_NODE)
...
function runOnWindowLoad(callback){function windowLoaded(){window.removeEventListener('DOMContentLoaded',windowLoaded,false);callback();}
if(document.readyState==='complete'||document.readyState==='interactive')
callback();else
window.addEventListener('DOMContentLoaded',windowLoaded,false);};self['ToolboxBootstrap']=self['ToolboxBootstrap']||{};(function(){function toolboxLoaded(){if(!window.opener)
