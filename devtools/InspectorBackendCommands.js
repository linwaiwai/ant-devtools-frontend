// File is generated by ant-devtools-frontend/scripts/build/code_generator_frontend.py
...
// Tiny.
InspectorBackend.registerEnum("Tiny.PseudoType", {FirstLine: "first-line", FirstLetter: "first-letter", Before: "before", After: "after", Backdrop: "backdrop", Selection: "selection", FirstLineInherited: "first-line-inherited", Scrollbar: "scrollbar", ScrollbarThumb: "scrollbar-thumb", ScrollbarButton: "scrollbar-button", ScrollbarTrack: "scrollbar-track", ScrollbarTrackPiece: "scrollbar-track-piece", ScrollbarCorner: "scrollbar-corner", Resizer: "resizer", InputListButton: "input-list-button"});
InspectorBackend.registerEnum("Tiny.ShadowRootType", {UserAgent: "user-agent", Open: "open", Closed: "closed"});
InspectorBackend.registerEvent("Tiny.documentUpdated", []);
InspectorBackend.registerCommand("Tiny.enable", [], [], false);
InspectorBackend.registerCommand("Tiny.getDocument", [], [], false);
InspectorBackend.registerCommand("Tiny.disable", [], [], false);
