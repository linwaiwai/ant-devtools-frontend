    ...
    if (children && children.length > 0) {
        children.forEach(function (next, index) {
            ...
            try {
                ...
                console.log('xixi', reactComponent);
                ...
                console.log('spe', speHandled);
                reactComponents[reactComponents.length - 1] = getTinyData(speHandled);
                console.log('cant know', reactComponents.length - 1, reactComponents);
            } catch (e) {
                console.error(e);
            }
        });
